...
const Dashboard: React.FC = () => {
  ...
  const [appointments, setAppointments] = useState<AppointmentsItens[]>([]);
  ...
  useEffect(() => {
    api
      .get<AppointmentsItens[]>(`/appointments/me`, {
        params: {
      ...
      <Content>
        <Schedule>
          ...
          <p>
            ...
            <span>{selectDateWeek}-feira</span>
          </p>
